...
urlpatterns = [
    ...
    path('stroj/create', views.CreateStrojView.as_view() ,name = 'create-stroj'),
    path('stroj/list', views.ListStrojView.as_view(),name = 'list-stroj'),
    path('stroj<int:pk>/detail', views.RetrieveStrojView.as_view(), name='retrieve-stroj'),
    path('stroj<int:pk>/delete', views.DestroyStrojView.as_view(), name='delete-stroj'),
    path('stroj<int:pk>/update', views.UpdateStrojView.as_view(), name='update-stroj'),
]
